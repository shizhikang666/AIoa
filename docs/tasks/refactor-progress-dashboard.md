...
Last updated: 2026-06-06 08:51 +08:00
...
| Frontend endpoints already routed | 315 | Matched against current ThinkPHP route paths |
...
| Frontend deferred write/side-effect candidates | 161 | Do not implement without module-specific write plans |
...
| Latest frontend-slice commit | See latest Git log | Current dashboard records warehouse base maintenance compatibility |
