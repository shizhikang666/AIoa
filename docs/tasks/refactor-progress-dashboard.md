...
Last updated: 2026-06-05 16:20 +08:00
...
| Registered route entries | 308 | Most are protected compatibility routes; customer, sale-project follow-up, product-info, field-change-log, history-Excel, project-rate, CC-record delete, team-project comment/reply base writes, team-project task assignee sync, and task comment add/edit/delete are now open |
...
| Frontend endpoints already routed | 296 | Matched against current ThinkPHP route paths |
...
| Frontend deferred write/side-effect candidates | 180 | Do not implement without module-specific write plans |
...
| Latest frontend-slice commit | See latest Git log | Current dashboard records team-project task comment maintenance compatibility |
