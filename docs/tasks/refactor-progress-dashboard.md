...
Last updated: 2026-06-05 12:33 +08:00
...
| Registered route entries | 293 | Most are protected compatibility routes; customer, sale-project follow-up, product-info, and field-change-log writes are now open |
...
| Frontend endpoints already routed | 281 | Matched against current ThinkPHP route paths |
...
| Frontend deferred write/side-effect candidates | 195 | Do not implement without module-specific write plans |
...
| Latest frontend-slice commit | See latest Git log | Current dashboard records sale-project field change log write compatibility |
