...
Last updated: 2026-06-05 15:59 +08:00
...
| Registered route entries | 305 | Most are protected compatibility routes; customer, sale-project follow-up, product-info, field-change-log, history-Excel, project-rate, CC-record delete, team-project comment/reply base writes, and team-project task assignee sync are now open |
...
| Frontend endpoints already routed | 293 | Matched against current ThinkPHP route paths |
...
| Frontend deferred write/side-effect candidates | 183 | Do not implement without module-specific write plans |
...
| Latest frontend-slice commit | See latest Git log | Current dashboard records team-project task assignee sync compatibility |
