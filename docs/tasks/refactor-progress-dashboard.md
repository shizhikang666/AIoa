...
Last updated: 2026-06-05 14:05 +08:00

Agent: merge-agent / main control agent

## Current Estimate

Overall production-ready completion: **61%**
...
| Registered route entries | 301 | Most are protected compatibility routes; customer, sale-project follow-up, product-info, field-change-log, history-Excel, project-rate, CC-record delete, and team-project comment/reply add writes are now open |
...
| Frontend endpoints already routed | 289 | Matched against current ThinkPHP route paths |
...
| Frontend deferred write/side-effect candidates | 187 | Do not implement without module-specific write plans |
...
| Latest frontend-slice commit | See latest Git log | Current dashboard records CC-record delete compatibility |
...
| Business reads/writes | Product, supplier, settlement account, payment record, expenditure record, collection receipt, debit note, file relation, team project, task/comments, warehouses, inventory, delivery, purchase order, return order, sale project reads; customer follow-up, sale-project follow-up, product-info, field-change-log, history-Excel, project-rate, CC-record delete, and team-project comment/reply add base writes | Most business writes deferred |
...
| Team project comment/reply reads and writes | `/biz/bizteamprojectcomment/detail`, `/biz/bizteamprojectcomment/add`, `/biz/bizteamprojectcommentreply/page`, `/detail`, and `/add` routed for copied project timeline comment/reply consumers, preserving project-member visibility guard and storing mentioned users under `EXT_JSON` | Comment delete, reply edit/delete, notifications, and data-change events deferred |
