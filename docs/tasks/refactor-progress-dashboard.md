...
Last updated: 2026-06-05 17:48 +08:00
...
| Frontend endpoints already routed | 312 | Matched against current ThinkPHP route paths |
...
| Frontend deferred write/side-effect candidates | 164 | Do not implement without module-specific write plans |
...
| Latest frontend-slice commit | See latest Git log | Current dashboard records supplier base maintenance compatibility |
