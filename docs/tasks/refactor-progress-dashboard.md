...
Last updated: 2026-06-03 15:00 +08:00
...
| Registered route entries | 257 | Most are protected read-only compatibility routes |
| API compatibility docs | 59 | Stored under `docs/api` |
...
| Frontend endpoints already routed | 251 | Matched against current ThinkPHP route paths |
| Frontend missing read/selector candidates | 87 | Priority candidates for safe compatibility slices |
