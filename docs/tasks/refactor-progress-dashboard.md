...
Last updated: 2026-06-05 15:29 +08:00
...
| Registered route entries | 304 | Most are protected compatibility routes; customer, sale-project follow-up, product-info, field-change-log, history-Excel, project-rate, CC-record delete, and team-project comment/reply base writes are now open |
...
| Frontend endpoints already routed | 292 | Matched against current ThinkPHP route paths |
...
| Frontend deferred write/side-effect candidates | 184 | Do not implement without module-specific write plans |
