...
Last updated: 2026-06-05 16:36 +08:00
...
| Registered route entries | 312 | Most are protected compatibility routes; customer, sale-project follow-up, product-info, field-change-log, history-Excel, project-rate, CC-record delete, team-project comment/reply base writes, team-project task category maintenance, team-project task assignee sync, and task comment add/edit/delete are now open |
...
| Frontend endpoints already routed | 300 | Matched against current ThinkPHP route paths |
...
| Frontend deferred write/side-effect candidates | 176 | Do not implement without module-specific write plans |
...
| Latest frontend-slice commit | See latest Git log | Current dashboard records team-project task category maintenance compatibility |
