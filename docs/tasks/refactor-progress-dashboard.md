...
Last updated: 2026-06-05 12:35 +08:00
...
| Registered route entries | 281 | Most are protected read-only compatibility routes |
...
| Frontend endpoints already routed | 269 | Matched against current ThinkPHP route paths |
...
| Latest frontend-slice commit | See latest Git log | Current dashboard records auth third user page read compatibility |
