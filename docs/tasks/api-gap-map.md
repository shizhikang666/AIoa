...
| Current ThinkPHP routes | 247 | From `php think route:list` after sale-profit read alias |
| Endpoints already covered by route path | 241 | Includes read adapters and auth/system routes |
| Missing read/selector/report candidates | 97 | Priority candidates for safe compatibility work |
...
| `biz/bizdatareport` | Sale-project amount/list/report, unpaid-payment, settlement income/expenses, sale-profit, and details reads |
