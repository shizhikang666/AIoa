...
| Current ThinkPHP routes | 246 | From `php think route:list` after settlement income/expenses read aliases |
| Endpoints already covered by route path | 240 | Includes read adapters and auth/system routes |
| Missing read/selector/report candidates | 98 | Priority candidates for safe compatibility work |
...
| `biz/bizdatareport` | Sale-project amount/list/report, unpaid-payment, settlement income/expenses, and details reads |
