...
export default {
	...
	// 动态文件上传，返回文件File
	fileUploadDynamicReturnFile(data) {
		return request('uploadDynamicReturnFile', data)
	},
	...
	// 本地文件上传，返回文件File
	fileUploadReturnFile(data) {
		return request('uploadLocalReturnFile', data)
	},
	// 阿里云文件上传，返回文件File
	fileUploadAliyunReturnFile(data) {
		return request('uploadAliyunReturnFile', data)
	},
	// 腾讯云文件上传，返回文件File
	fileUploadTencentReturnFile(data) {
		return request('uploadTencentReturnFile', data)
	},
	// MINIO文件上传，返回文件File
	fileUploadMinioReturnFile(data) {
		return request('uploadMinioReturnFile', data)
	},
