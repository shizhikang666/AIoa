<template>
		...
		>
			<template #operator class="table-operator">
				<a-space>
					...
					<a-button v-if="hasPerm('bizSpecialProjectAdd')" @click="publicOrgFormRef.onOpen()">
						录入公共组织订单
					</a-button>
					<xn-batch-delete
						confirmTitle="作废此信息？"
	...
	<publicOrgForm ref="publicOrgFormRef" />
</template>
<script setup name="saleproject">
	...
	import publicOrgForm from './form/publicOrgForm.vue'
