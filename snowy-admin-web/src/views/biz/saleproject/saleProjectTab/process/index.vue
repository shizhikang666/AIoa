<template>
	<a-card :bordered="false">
		...
		<!--						></a-select>-->
		<!--						&lt;!&ndash;						<a-input v-model:value="searchFormState.category" placeholder="请输入流程类别" />&ndash;&gt;-->
		<!--					</a-form-item>-->
		<!--				</a-col>-->
		<!--				<a-col :span="6">-->
...
<script setup name="projectProcess">
	...
	const loadData = async () => {
		...
		data.value = await bizProcessApi.bizProcessProjectRuntimeQueryList(
			Object.assign(searchFormParam, { projectId: id })
		)
	}
