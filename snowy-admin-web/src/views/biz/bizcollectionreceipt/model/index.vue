...
<script setup name="bizCollectionReceiptModel">
	...
	const loadData = async (parameter) => {
		...
		const result = await bizCollectionReceiptApi
			.bizCollectionReceiptPage(Object.assign(parameter, searchFormParam, defaultSearchFrom))
			.then((data) => {
				return data
			})
