<template>
	...
	<EditTargetForm ref="editTargetFormReF" @successful="tableRef.refresh()" />
</template>
...
<script setup name="bizexpenditurerecord">
	...
	const settlementCategoryOptions = tool.dictListByPath('SETTLEMENT_ACCOUNT', 'SETTLEMENT_CATEGORY', 'INCOME_CATEGORY')
</script>
