			...
			<a-tabs v-model:activeKey="activeTabsKey">
				<a-tab-pane key="1" tab="基础信息" force-render>
					...
					<a-row :gutter="16">
						...
						<a-col :span="12">
							<a-form-item label="基本工资：" name="basicSalary">
								<XnCurrencyInput v-model="formData.basicSalary"></XnCurrencyInput>
							</a-form-item>
						</a-col>
					</a-row>
					<a-row :gutter="16">
					...
					<a-row :gutter="16" v-if="formData.id">
						<a-col :span="12">
							<a-typography-paragraph :copyable="{ text: formData.companyEmployeeId }">
								<a-typography-text :level="2">企业员工编号:</a-typography-text>
								{{ formData.companyEmployeeId }}
				...
				<a-tab-pane key="2" tab="更多信息" force-render>
					...
					<a-row :gutter="16">
						<a-col :span="12">
							<a-form-item label="籍贯住址：" name="homeAddress">
								<a-textarea
