<template>
	...
	>
		...
		<a-form-item label="开户行地址：" name="bankName">
			<a-input v-model:value="formData.bankName" placeholder="请输入开户行地址" allow-clear />
		</a-form-item>
		<a-form-item label="开户行账号：" name="bankAccount">
			<a-input v-model:value="formData.bankAccount" placeholder="请输入开户行账号" allow-clear />
		</a-form-item>
