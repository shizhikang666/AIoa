...
class FieldController extends BaseSysController
{
    ...
    {
        return $this->guard(fn () => $this->resourceService->fieldAdd(
    ...
    {
        return $this->guard(fn () => $this->resourceService->fieldEdit(
            $this->bodyInput($request),
            $request->middleware('auth_payload', [])
        ));
    }
    ...
    public function delete(Request $request): Response
    {
        return $this->guard(function () use ($request): array {
            ...
            return $this->resourceService->fieldDelete(
    ...
    private function deleteIds(array $input): array
    {
        ...
        foreach (['idList', 'ids', 'id', 'fieldIds'] as $key) {
