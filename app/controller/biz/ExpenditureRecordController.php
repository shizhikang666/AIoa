...
class ExpenditureRecordController extends BaseSysController
{
    ...
    {
        return $this->guard(fn () => $this->expenditureRecordService->add($this->body($request), $this->authPayload($request)));
    }
    ...
    public function delete(Request $request): Response
    {
        return $this->guard(function () use ($request): array {
            ...
            return $this->expenditureRecordService->delete($this->deleteIds($request, $input), $this->authPayload($request));
        });
    }
